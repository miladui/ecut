    ...
    <g>
        ...
        <div class="body-auth overflow-y-auto pb-[1rem]	h-[90%]  w-full flex flex-col items-center">
            ...
            <div class="p-input mt-[5rem] flex flex-col items-center w-[90%]">
                ...
                <input class="w-[85%] mt-[1rem] text-left h-[45px] px-[1.5rem] rounded-[5px] text-[16px]" type="text"
                       placeholder="مثال: 09125873251">
                <a href=""
                   class="btn-base flex items-center rounded-[4px] mt-[1rem] justify-center w-[85%]">
                    ادامـــــه
